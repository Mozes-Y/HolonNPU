module npu_v2_local_memory_test_wrapper (
    input  logic        clk_i,
    input  logic        rst_ni,
    ...
    input  logic        client_data_rd_valid_i,
    output logic        client_data_rd_ready_o,
    input  logic [31:0] client_data_rd_addr_i,
    output logic        client_data_rd_valid_o,
    output logic [31:0] client_data_rd_data_o,
    output logic        client_data_rd_error_o
);
    ...
    npu_v2_localmem_wr_if client_data_wr_if (
        .clk_i(clk_i),
        .rst_ni(rst_ni)
    );

    npu_v2_localmem_wr_if memory_data_wr_if (
        .clk_i(clk_i),
        .rst_ni(rst_ni)
    );
    ...
    npu_v2_localmem_rd_if client_data_rd_if (
        .clk_i(clk_i),
        .rst_ni(rst_ni)
    );
    ...
    assign client_data_rd_if.req_valid = client_data_rd_valid_i;
    assign client_data_rd_ready_o = client_data_rd_if.req_ready;
    assign client_data_rd_if.req_addr = client_data_rd_addr_i;
    assign client_data_rd_valid_o = client_data_rd_if.resp_valid;
    assign client_data_rd_data_o = client_data_rd_if.resp_data;
    assign client_data_rd_error_o = client_data_rd_if.resp_error;
    ...
    npu_v2_local_memory_core u_core (
        .clk_i(clk_i),
        .rst_ni(rst_ni),
        .soft_reset_i(soft_reset_i),
