module npu_frontend_tile_test_wrapper #(
    ...
    npu_frontend_tile_core #(
        ...
        .frontend_running_o(frontend_running_o),
        .frontend_halted_o(frontend_halted_o),
        .frontend_done_o(frontend_done_o),
        .frontend_fault_o(frontend_fault_o),
        .frontend_fault_code_o(frontend_fault_code_o),
        .frontend_debug_pc_o(frontend_debug_pc_o),
        .frontend_instret_o(frontend_instret_o)
    );
