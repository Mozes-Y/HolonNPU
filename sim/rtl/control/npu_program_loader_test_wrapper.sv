...
module npu_program_loader_test_wrapper #(
    ...
    npu_program_loader_ready_sink_test_wrapper u_program_wr_sink (
        .ready_i(program_wr_ready_i),
        .local_wr(program_wr_if)
    );

    npu_program_loader_ready_sink_test_wrapper u_data_wr_sink (
...
module npu_program_loader_ready_sink_test_wrapper (
    input logic ready_i,
    npu_localmem_wr_if.slave local_wr
);
