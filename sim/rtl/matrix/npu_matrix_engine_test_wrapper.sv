...
module npu_matrix_engine_test_wrapper (
    input  logic         clk_i,
    input  logic         rst_ni,
    ...
    npu_localmem_wr_if host_wr_if (.clk_i(clk_i), .rst_ni(rst_ni));
    npu_localmem_wr_if matrix_wr_if (.clk_i(clk_i), .rst_ni(rst_ni));
    npu_localmem_wr_if memory_wr_if (.clk_i(clk_i), .rst_ni(rst_ni));
    npu_localmem_wr_if program_wr_if (.clk_i(clk_i), .rst_ni(rst_ni));
    npu_localmem_rd_if matrix_rd_if (.clk_i(clk_i), .rst_ni(rst_ni));
    npu_localmem_rd_if memory_rd_if (.clk_i(clk_i), .rst_ni(rst_ni));
    npu_localmem_rd_if program_rd_if (.clk_i(clk_i), .rst_ni(rst_ni));
    ...
    npu_matrix_engine_core matrix_engine (
        .clk_i(clk_i),
        .rst_ni(rst_ni),
