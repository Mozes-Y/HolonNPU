...
def main() -> int:
    ...
    pairs = [
        ...
        ("desc off size", "NPU_DESC_OFF_SIZE_BYTES", "HOLON_NPU_DESC_OFF_SIZE_BYTES"),
        ("desc off version", "NPU_DESC_OFF_VERSION", "HOLON_NPU_DESC_OFF_VERSION"),
        ("desc off opcode", "NPU_DESC_OFF_OPCODE", "HOLON_NPU_DESC_OFF_OPCODE"),
        ("desc off flags", "NPU_DESC_OFF_FLAGS", "HOLON_NPU_DESC_OFF_FLAGS"),
        ("desc off m", "NPU_DESC_OFF_M", "HOLON_NPU_DESC_OFF_M"),
        ("desc off n", "NPU_DESC_OFF_N", "HOLON_NPU_DESC_OFF_N"),
        ("desc off k", "NPU_DESC_OFF_K", "HOLON_NPU_DESC_OFF_K"),
        ("desc off reserved_14", "NPU_DESC_OFF_RESERVED_14", "HOLON_NPU_DESC_OFF_RESERVED_14"),
        ("desc off a_addr", "NPU_DESC_OFF_A_ADDR", "HOLON_NPU_DESC_OFF_A_ADDR"),
        ("desc off b_addr", "NPU_DESC_OFF_B_ADDR", "HOLON_NPU_DESC_OFF_B_ADDR"),
        ("desc off c_addr", "NPU_DESC_OFF_C_ADDR", "HOLON_NPU_DESC_OFF_C_ADDR"),
        ("desc off a_stride", "NPU_DESC_OFF_A_STRIDE", "HOLON_NPU_DESC_OFF_A_STRIDE"),
        ("desc off b_stride", "NPU_DESC_OFF_B_STRIDE", "HOLON_NPU_DESC_OFF_B_STRIDE"),
        ("desc off c_stride", "NPU_DESC_OFF_C_STRIDE", "HOLON_NPU_DESC_OFF_C_STRIDE"),
        ("desc off reserved_3c", "NPU_DESC_OFF_RESERVED_3C", "HOLON_NPU_DESC_OFF_RESERVED_3C"),
        ("desc off reserved tail", "NPU_DESC_OFF_RESERVED_TAIL", "HOLON_NPU_DESC_OFF_RESERVED_TAIL"),
        ("array K lanes", "NPU_ARRAY_K", "HOLON_NPU_ARRAY_K"),
