...
HOLON_NPU_STATIC_ASSERT(offsetof(holon_npu_gemm_desc_t, reserved_48) == 0x48,
                        "descriptor reserved_48 offset mismatch");
HOLON_NPU_STATIC_ASSERT(offsetof(holon_npu_gemm_desc_t, reserved_50) == 0x50,
                        "descriptor reserved_50 offset mismatch");
HOLON_NPU_STATIC_ASSERT(offsetof(holon_npu_gemm_desc_t, reserved_58) == 0x58,
                        "descriptor reserved_58 offset mismatch");
HOLON_NPU_STATIC_ASSERT(offsetof(holon_npu_gemm_desc_t, reserved_60) == 0x60,
                        "descriptor reserved_60 offset mismatch");
HOLON_NPU_STATIC_ASSERT(offsetof(holon_npu_gemm_desc_t, reserved_68) == 0x68,
                        "descriptor reserved_68 offset mismatch");
HOLON_NPU_STATIC_ASSERT(offsetof(holon_npu_gemm_desc_t, reserved_70) == 0x70,
