...
interface npu_axi4_if #(
    ...
    axi_write_burst_seen: cover property (
        @(posedge aclk_i) disable iff (!aresetn_i)
            awvalid && awready
    );
