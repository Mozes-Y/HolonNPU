...
module npu_engine_data_arbiter_core (
    input  logic                  clk_i,
    input  logic                  rst_ni,
    input  logic                  soft_reset_i,

    npu_localmem_wr_if.slave   dma_wr,
    npu_localmem_wr_if.slave   vector_wr,
    npu_localmem_wr_if.slave   matrix_wr,
    npu_localmem_wr_if.slave   scalar_wr,
    npu_localmem_wr_if.master  memory_wr,

    npu_localmem_rd_if.slave   dma_rd,
    npu_localmem_rd_if.slave   vector_rd,
    npu_localmem_rd_if.slave   matrix_rd,
    npu_localmem_rd_if.slave   scalar_rd,
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
     ...
     engine_data_arbiter_single_write_grant: assert property (
