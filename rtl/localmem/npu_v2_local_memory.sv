...
module npu_v2_local_memory_core #(
    ...
    npu_v2_localmem_wr_if.slave program_wr,
    npu_v2_localmem_wr_if.slave data_wr,

    npu_v2_localmem_rd_if.slave program_rd,
    npu_v2_localmem_rd_if.slave data_rd
);
