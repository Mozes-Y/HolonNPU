...
module npu_matrix_engine_core #(
    ...
    task automatic complete_fault();
        begin
            event_fault_q <= 1'b1;
            event_fault_code_q <= NPU_FAULT_MATRIX_ISSUE;
            state_q <= STATE_EVENT;
        end
    endtask
